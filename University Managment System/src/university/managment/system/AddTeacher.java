...
public class AddTeacher extends JFrame implements ActionListener {
    ...
    AddTeacher() {
        ...
        this.labelEmpID = new JLabel("181" + this.first4);
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == this.submit) {
            ...
            String ID = this.labelEmpID.getText();
...
//                
//                JOptionPane.showMessageDialog((Component)null, "Teacher Details Added Successfully");
